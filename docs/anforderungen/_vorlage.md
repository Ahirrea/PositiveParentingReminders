...
README.md die Tabellenzeile aktualisieren (dort lebt der Status).
-->
...
**Verfeinert am:** &lt;Datum&gt;
**Bedient PRD:** &lt;Abschnitt in `../PRD.md`, z. B. „3 Ziele — Rückblick über Wochen"&gt;
...
&lt;Konflikt mit `../PRD.md` / ADR / Prinzipien benennen und auflösen&gt;
